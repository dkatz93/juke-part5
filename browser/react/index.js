  ...
  <Provider store={store}>
    <Router history={browserHistory}>
      <Route path="/" component={App} onEnter={onAppEnter}>
        ...
        <Route path='/stations' onEnter={onStationsEnter} component={StationsContainer} />
        <Route path='stations/:stationName' onEnter={onStationsEnter} component={StationContainer}/>
